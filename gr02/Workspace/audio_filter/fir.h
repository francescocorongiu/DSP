...
void fir_linear_fixed(int *x, float *h, float *r, float *dbuffer, unsigned short nx, unsigned short nh);
void fir_circular_fixed(int *x, float *h, float *r, float *dbuffer, unsigned short nx, unsigned short nh);
